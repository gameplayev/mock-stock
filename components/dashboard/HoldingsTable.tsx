  ...
  return (
    <div className="rounded-3xl border border-white/5 bg-white/[0.04] p-6 shadow-2xl shadow-black/30 backdrop-blur">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-white">주식 현황</h2>
              ...
              >
                ...
                <td className="px-4 py-4">
                  <div className="flex flex-col">
                    ...
                    <span className={`text-[10px] uppercase tracking-[0.25em] ${trendTone(holding.change)}`}>
                      {trendLabel(holding.change)}
                    </span>
